...
namespace FPS.Scripts.Game.Managers.NavMesh
{
    ...
    public class NavMeshSurface : MonoBehaviour
    {
        ...
        public void AddData()
        {
            ...
            {
                m_NavMeshDataInstance = UnityEngine.AI.NavMesh.AddNavMeshData(m_NavMeshData, transform.position, transform.rotation);
        ...
        {
            var buildSettings = UnityEngine.AI.NavMesh.GetSettingsByID(m_AgentTypeID);
        ...
        static void Register(NavMeshSurface surface)
        {
            ...
            if (s_NavMeshSurfaces.Count == 0)
                UnityEngine.AI.NavMesh.onPreUpdate += UpdateActive;
        ...
        void OnValidate()
        {
            ...
            var settings = UnityEngine.AI.NavMesh.GetSettingsByID(m_AgentTypeID);
